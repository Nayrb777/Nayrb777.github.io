...
<div class="service bg-gray">
    <div class="container">
        <div class="row">
            <?php
                $statement = $pdo->prepare("SELECT * FROM tbl_servicio");
                $statement->execute();
                $result = $statement->fetchAll(PDO::FETCH_ASSOC);                            
                foreach ($result as $row) {
                    ?>
                    <div class="col-md-4">
                        <div class="item">
                            <div class="photo"><img src="assets/uploads/<?php echo $row['foto']; ?>" alt="<?php echo $row['titulo']; ?>"></div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="product-carousel">
                    ...
                    <?php
                    $statement = $pdo->prepare("SELECT * FROM tbl_producto WHERE p_es_destacado=? AND p_esta_activo=? LIMIT ".$total_featured_product_home);
                    ...
                    foreach ($result as $row) {
                        ...
                        <div class="item">
                            ...
                            <div class="text">
                                <h3><a href="producto.php?id=<?php echo $row['p_id']; ?>"><?php echo $row['p_nombre']; ?></a></h3>
                                <h4>
                                    S/.<?php echo $row['p_precio_actual']; ?> 
                                    <?php if($row['p_precio_anterior'] != ''): ?>
                                    <del>
                                        S/.<?php echo $row['p_precio_anterior']; ?>
                                    </del>
                                    <?php endif; ?>
                                </h4>
                                <div class="rating">
                                ...
                                <?php else: ?>
                                    <p><a href="producto.php?id=<?php echo $row['p_id']; ?>">Añadir al carrito</a></p>
                                <?php endif; ?>
                            </div>
                        </div>
                        <?php
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="product-carousel">
                    ...
                    <?php
                    $statement = $pdo->prepare("SELECT * FROM tbl_producto WHERE p_esta_activo=? ORDER BY p_id DESC LIMIT ".$total_latest_product_home);
                    ...
                    foreach ($result as $row) {
                        ...
                        <div class="item">
                            ...
                            <div class="text">
                                <h3><a href="producto.php?id=<?php echo $row['p_id']; ?>"><?php echo $row['p_nombre']; ?></a></h3>
                                <h4>
                                    $<?php echo $row['p_precio_actual']; ?> 
                                    <?php if($row['p_precio_anterior'] != ''): ?>
                                    <del>
                                        $<?php echo $row['p_precio_anterior']; ?>
                                    </del>
                                    <?php endif; ?>
                                </h4>
                                <div class="rating">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="product-carousel">
                    ...
                    <?php
                    $statement = $pdo->prepare("SELECT * FROM tbl_producto WHERE p_esta_activo=? ORDER BY p_vistas_totales DESC LIMIT ".$total_popular_product_home);
                    $statement->execute(array(1));
                    $result = $statement->fetchAll(PDO::FETCH_ASSOC);                            
                    foreach ($result as $row) {
                        ?>
