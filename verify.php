...
if ( (!isset($_REQUEST['email'])) || (isset($_REQUEST['token'])) )
{
    ...
    if($var != 0)
    {
        ...
        $success_message = '<p style="color:green;">Su correo electrónico se ha verificado correctamente. Ya puedes iniciar sesión en nuestro sitio web.</p><p><a href="'.BASE_URL.'login.php" style="color:#167ac6;font-weight:bold;">Haga clic aquí para ingresar</a></p>';     
    }
}
?>
