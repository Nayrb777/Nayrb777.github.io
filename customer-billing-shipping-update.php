...
if (isset($_POST['form1'])) {
    ...
    $statement->execute(array(
                            ...
                            strip_tags($_POST['cust_b_distrito']),
                            ...
                            strip_tags($_POST['cust_s_distrito']),
    ...
    $_SESSION['customer']['cust_b_distrito'] = strip_tags($_POST['cust_b_distrito']);
    ...
    $_SESSION['customer']['cust_s_distrito'] = strip_tags($_POST['cust_s_distrito']);
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="cust_b_distrito" class="form-control">
                                        <?php
                                        ...
                                        foreach ($result as $row) {
                                            ?>
                                            <option value="<?php echo $row['distrito_id']; ?>" <?php if($row['distrito_id'] == $_SESSION['customer']['cust_b_distrito']) {echo 'selected';} ?>><?php echo $row['distrito_name']; ?></option>
                                            <?php
                                        }
                                        ?>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="cust_b_city" value="Lima" readonly > 
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="cust_b_state" value="Lima" readonly > 
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for=""><?php echo LANG_VALUE_106; ?></label>
                                    <select name="cust_s_distrito" class="form-control">
                                        <?php
                                        $statement = $pdo->prepare("SELECT * FROM tbl_distrito ORDER BY distrito_name ASC");
                                        $statement->execute();
                                        $result = $statement->fetchAll(PDO::FETCH_ASSOC);
                                        foreach ($result as $row) {
                                            ?>
                                            <option value="<?php echo $row['distrito_id']; ?>" <?php if($row['distrito_id'] == $_SESSION['customer']['cust_s_distrito']) {echo 'selected';} ?>><?php echo $row['distrito_name']; ?></option>
                                            <?php
                                        }
                                        ?>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="cust_s_city" value="Lima" readonly > 
                                </div>
                                <div class="form-group">
                                    <label for=""><?php echo LANG_VALUE_108; ?></label>
                                    <!--<input type="text" class="form-control" name="cust_s_state" value="<?php echo $_SESSION['customer']['cust_s_state']; ?>">-->
                                    <input type="text" class="form-control" name="cust_s_state" value="Lima" readonly > 
                                </div>
                                <div class="form-group">
                                    <label for=""><?php echo LANG_VALUE_109; ?></label>
