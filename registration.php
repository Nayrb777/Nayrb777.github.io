                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <select name="cust_distrito" class="form-control select2">
                                        <option value="">Selecciona tu Distrito</option>
                                    <?php
                                    $statement = $pdo->prepare("SELECT * FROM tbl_distrito where distrito_activo = 1 ORDER BY distrito_nombre ASC");
                                    $statement->execute();
                                    $result = $statement->fetchAll(PDO::FETCH_ASSOC);                            
                                    foreach ($result as $row) {
                                        ?>
                                        <option value="<?php echo $row['distrito_id']; ?>"><?php echo $row['distrito_nombre']; ?></option>
                                        <?php
                                    }
                                    ?>    
                                    </select>                                    
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" class="form-control" name="cust_city" value="Lima" readonly > 
                                </div>
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" class="form-control" name="cust_state" value="Lima" readonly>
                                </div>
                                <div class="col-md-6 form-group">
